...
`pak``::`[`pak`](https://pak.r-lib.org/reference/pak.html)`(``"pharmaverse/rtables"``)`
...
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"AGE"``, ``"BMRKR1"``, ``"BMRKR2"``)``, ``function``(``x``, ``...``)`` ``{`\
`    ``if`` ``(`[`is.numeric`](https://rdrr.io/r/base/numeric.html)`(``x``)``)`` ``{`\
`      `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`        ``"Mean (sd)"`` ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`[`mean`](https://rdrr.io/r/base/mean.html)`(``x``)``, `[`sd`](https://rdrr.io/r/stats/sd.html)`(``x``)``)``,`\
`        ``"Median"`` ``=`` `[`median`](https://rdrr.io/r/stats/median.html)`(``x``)``,`\
`        ``"Min - Max"`` ``=`` `[`range`](https://rdrr.io/r/base/range.html)`(``x``)``,`\
`        .formats ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"xx.xx (xx.xx)"``, ``"xx.xx"``, ``"xx.xx - xx.xx"``)`\
`      ``)`\
`    ``}`` ``else`` ``if`` ``(`[`is.factor`](https://rdrr.io/r/base/factor.html)`(``x``)`` ``||`` `[`is.character`](https://rdrr.io/r/base/character.html)`(``x``)``)`` ``{`\
`      `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(``.list ``=`` `[`list_wrap_x`](https://pharmaverse.github.io/rtables/reference/list_wrap.md)`(``table``)``(``x``)``)`\
`    ``}`` ``else`` ``{`\
...
`ADSL`` ``<-`` ``ex_adsl`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``RACE`` `[`%in%`](https://rdrr.io/r/base/match.html)` `[`levels`](https://rdrr.io/r/base/levels.html)`(``RACE``)``[``1``:``3``]``)`\
\
`biomarker_ave`` ``<-`` ``function``(``x``, ``...``)`` ``{`\
`  ``val`` ``<-`` ``if`` ``(`[`length`](https://rdrr.io/r/base/length.html)`(``x``)`` ``>`` ``0``)`` `[`round`](https://rdrr.io/r/base/Round.html)`(`[`mean`](https://rdrr.io/r/base/mean.html)`(``x``)``, ``2``)`` ``else`` ``"no data"`\
`  `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`    ``"Biomarker 1 (mean)"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(``val``)`\
`  ``)`\
`}`\
\
[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``show_colcounts ``=`` ``TRUE``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"BMRKR2"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"RACE"``, split_fun ``=`` `[`trim_levels_in_group`](https://pharmaverse.github.io/rtables/reference/split_funcs.md)`(``"SEX"``)``)`` ``|>`\
...
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"BMRKR1"``, ``biomarker_ave``)`` ``|>`\
`  `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``ADSL``)`\
`#>                                          A: Drug X                            B: Placebo                           C: Combination           `\
