...
\
[`as_result_df`](https://pharmaverse.github.io/rtables/reference/data.frame_export.md)`(``tbl``)`\
...
`# 5    DataRow         1          0              2`\
\
[`as_result_df`](https://pharmaverse.github.io/rtables/reference/data.frame_export.md)`(``tbl``, data_format ``=`` ``"strings"``)`\
`#   avar_name         row_name       label_name row_num is_group_summary`\
`# 1       AGE             Mean             Mean       2            FALSE`\
`# 2       SEX                F                F       4            FALSE`\
`# 3       SEX                M                M       5            FALSE`\
...
`# 4    DataRow         3          2              4`\
`# 5    DataRow         1          0              2`\
[`as_result_df`](https://pharmaverse.github.io/rtables/reference/data.frame_export.md)`(``tbl``, simplify ``=`` ``TRUE``)`\
...
[`as_result_df`](https://pharmaverse.github.io/rtables/reference/data.frame_export.md)`(``tbl``, simplify ``=`` ``TRUE``, keep_label_rows ``=`` ``TRUE``)`\
`#         label_name A: Drug X B: Placebo C: Combination`\
`# 1              AGE        NA         NA             NA`\
...
[`as_result_df`](https://pharmaverse.github.io/rtables/reference/data.frame_export.md)`(``tbl``, simplify ``=`` ``TRUE``, keep_label_rows ``=`` ``TRUE``, expand_colnames ``=`` ``TRUE``)`\
`#                label_name A: Drug X B: Placebo C: Combination`\
...
\
[`as_result_df`](https://pharmaverse.github.io/rtables/reference/data.frame_export.md)`(``tbl``, make_ard ``=`` ``TRUE``)`\
...
`rc`` ``<-`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``2``)``, stat_names ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Rand1"``, ``"Rand2"``)``)`\
[`print`](https://rdrr.io/r/base/print.html)`(`[`obj_stat_names`](https://pharmaverse.github.io/rtables/reference/int_methods.md)`(``rc``)``)`` ``# c("Rand1", "Rand2")`\
`# [1] "Rand1" "Rand2"`\
\
`rc_row`` ``<-`` `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`  .list ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``a ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``NA``, ``1``)``, b ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``NA``)``)``,`\
`  .formats ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"xx - xx"``, ``"xx.x - xx.x"``)``,`\
`  .format_na_strs ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"asda"``, ``"lkjklj"``)``)``,`\
`  .stat_names ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"A"``, ``"B"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"B"``, ``"C"``)``)`\
`)`\
\
`# Only a getter for this object`\
[`print`](https://rdrr.io/r/base/print.html)`(`[`obj_stat_names`](https://pharmaverse.github.io/rtables/reference/int_methods.md)`(``rc_row``)``)`` ``# list(a = c("A", "B"), b = c("B", "C"))`\
`# $a`\
`# [1] "A" "B"`\
`# `\
`# $b`\
...
`  .formats ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"xx - xx"``, ``"xx.x - xx.x"``)``,`\
`  .format_na_strs ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"asda"``, ``"lkjklj"``)``)``,`\
`  .stat_names ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"A"``, ``"B"``)`\
`)`\
[`print`](https://rdrr.io/r/base/print.html)`(`[`obj_stat_names`](https://pharmaverse.github.io/rtables/reference/int_methods.md)`(``rc_row``)``)`` ``# c("A", "B") # one for each row`\
`# $a`\
`# [1] "A"`\
`# `\
`# $b`\
`# [1] "B"`\
[`print`](https://rdrr.io/r/base/print.html)`(`[`lapply`](https://rdrr.io/r/base/lapply.html)`(``rc_row``, ``obj_stat_names``)``)`` ``# identical to above + row names`\
`# $a`\
`# [1] "A"`\
`# `\
`# $b`\
...
`  .formats ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"xx - xx"``, ``"xx.x - xx.x"``)``,`\
`  .format_na_strs ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"asda"``, ``"lkjklj"``)``)``,`\
`  .stat_names ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"A"``, ``"B"``)``)`` ``# It is duplicated, check it yourself!`\
`)`
...
`  ``mean`` ``<-`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``x``, na.rm ``=`` ``FALSE``)`\
`  ``sd`` ``<-`` `[`sd`](https://rdrr.io/r/stats/sd.html)`(``x``, na.rm ``=`` ``FALSE``)`\
\
`  `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``mean``, ``sd``)``,`\
`    label ``=`` ``"Mean (SD)"``, format ``=`` ``"xx.x (xx.x)"`` ``# ,`\
`    ``# stat_names = c("Mean", "SD")`\
`  ``)`\
`}`\
`counts_percentage_custom`` ``<-`` ``function``(``x``)`` ``{`\
`  ``cnts`` ``<-`` `[`table`](https://rdrr.io/r/base/table.html)`(``x``)`\
`  ``out`` ``<-`` `[`lapply`](https://rdrr.io/r/base/lapply.html)`(``cnts``, ``function``(``x``)`` ``{`\
`    ``perc`` ``<-`` ``x`` ``/`` `[`sum`](https://rdrr.io/r/base/sum.html)`(``cnts``)`\
`    `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``x``, ``perc``)``, format ``=`` ``"xx. (xx.%)"``)`\
`  ``}``)`\
`  `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`    .list ``=`` `[`as.list`](https://rdrr.io/r/base/list.html)`(``out``)``, .labels ``=`` `[`names`](https://rdrr.io/r/base/names.html)`(``cnts``)``,`\
`    .stat_names ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Count"``, ``"Percentage"``)``)`\
`  ``)`\
`}`\
\
`lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``show_colcounts ``=`` ``TRUE``, colcount_format ``=`` ``"N=xx"``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``, split_fun ``=`` `[`keep_split_levels`](https://pharmaverse.github.io/rtables/reference/split_funcs.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"A: Drug X"``, ``"B: Placebo"``)``)``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``vars ``=`` ``"AGE"``, afun ``=`` ``mean_sd_custom``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``vars ``=`` ``"SEX"``, afun ``=`` ``counts_percentage_custom``)`\
\
...
\
`lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA2"``)`` ``|>`\
