...
`  arm ``=`` `[`factor`](https://rdrr.io/r/base/factor.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Arm A"``, ``"Arm B"``)``, ``n``, replace ``=`` ``TRUE``)``, levels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Arm A"``, ``"Arm B"``)``)``,`\
`  country ``=`` `[`factor`](https://rdrr.io/r/base/factor.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"CAN"``, ``"USA"``)``, ``n``, replace ``=`` ``TRUE``, prob ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``.55``, ``.45``)``)``, levels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"CAN"``, ``"USA"``)``)``,`\
`  gender ``=`` `[`factor`](https://rdrr.io/r/base/factor.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Female"``, ``"Male"``)``, ``n``, replace ``=`` ``TRUE``)``, levels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Female"``, ``"Male"``)``)``,`\
`  handed ``=`` `[`factor`](https://rdrr.io/r/base/factor.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Left"``, ``"Right"``)``, ``n``, prob ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``.6``, ``.4``)``, replace ``=`` ``TRUE``)``, levels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Left"``, ``"Right"``)``)``,`\
`  age ``=`` `[`rchisq`](https://rdrr.io/r/stats/Chisquare.html)`(``n``, ``30``)`` ``+`` ``10`\
`)`` ``|>`` `[`mutate`](https://dplyr.tidyverse.org/reference/mutate.html)`(`\
`  weight ``=`` ``35`` ``*`` `[`rnorm`](https://rdrr.io/r/stats/Normal.html)`(``n``, sd ``=`` ``.5``)`` ``+`` `[`ifelse`](https://rdrr.io/r/base/ifelse.html)`(``gender`` ``==`` ``"Female"``, ``140``, ``180``)`\
`)`\
\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"gender"``)`` ``|>`\
...
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"handed"``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"age"``, afun ``=`` ``mean``, format ``=`` ``"xx.x"``)`\
\
...
\
[`mean`](https://rdrr.io/r/base/mean.html)`(``df``$``age``[``df``$``country`` ``==`` ``"CAN"`` ``&`` ``df``$``arm`` ``==`` ``"Arm A"`` ``&`` ``df``$``gender`` ``==`` ``"Female"`` ``&`` ``df``$``handed`` ``==`` ``"Left"``]``)`\
`# [1] 38.86979`
...
\
`df`` ``|>`\
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``country`` ``==`` ``"CAN"``, ``arm`` ``==`` ``"Arm A"``, ``gender`` ``==`` ``"Female"``, ``handed`` ``==`` ``"Left"``)`` ``|>`\
...
\
`df`` ``|>`\
`  `[`group_by`](https://dplyr.tidyverse.org/reference/group_by.html)`(``arm``, ``gender``)`` ``|>`\
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``country`` ``==`` ``"CAN"``, ``handed`` ``==`` ``"Left"``)`` ``|>`\
`  `[`summarise`](https://dplyr.tidyverse.org/reference/summarise.html)`(``mean_age ``=`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``age``)``)`\
...
\
`average_age`` ``<-`` ``df`` ``|>`\
`  `[`group_by`](https://dplyr.tidyverse.org/reference/group_by.html)`(``arm``, ``gender``, ``country``, ``handed``)`` ``|>`\
`  `[`summarise`](https://dplyr.tidyverse.org/reference/summarise.html)`(``mean_age ``=`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``age``)``)`\
`` # `summarise()` has regrouped the output. ``\
...
`c_h_df`` ``<-`` ``df`` ``|>`\
`  `[`group_by`](https://dplyr.tidyverse.org/reference/group_by.html)`(``arm``, ``gender``, ``country``, ``handed``)`` ``|>`\
`  `[`summarize`](https://dplyr.tidyverse.org/reference/summarise.html)`(``mean ``=`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``age``)``, c_h_count ``=`` `[`n`](https://dplyr.tidyverse.org/reference/context.html)`(``)``)`` ``|>`\
`  ``## we need the sum below to *not* be by country, so that we're dividing by the column counts`\
`  `[`ungroup`](https://dplyr.tidyverse.org/reference/group_by.html)`(``country``)`` ``|>`\
`  ``` # now the `handed` grouping has been removed, therefore we can calculate percent now: ``\
`  `[`mutate`](https://dplyr.tidyverse.org/reference/mutate.html)`(``n_col ``=`` `[`sum`](https://rdrr.io/r/base/sum.html)`(``c_h_count``)``, c_h_percent ``=`` ``c_h_count`` ``/`` ``n_col``)`\
`` # `summarise()` has regrouped the output. ``\
`# ``ℹ`` Summaries were computed grouped by ``arm``, ``gender``, ``country``, and ``handed``.`\
`# ``ℹ`` Output is grouped by ``arm``, ``gender``, and ``country``.`\
`# ``ℹ```  Use `summarise(.groups = "drop_last")` to silence this message. ``\
...
\
`c_df`` ``<-`` ``df`` ``|>`\
`  `[`group_by`](https://dplyr.tidyverse.org/reference/group_by.html)`(``arm``, ``gender``, ``country``)`` ``|>`\
`  `[`summarize`](https://dplyr.tidyverse.org/reference/summarise.html)`(``c_count ``=`` `[`n`](https://dplyr.tidyverse.org/reference/context.html)`(``)``)`` ``|>`\
`  ``` # now the `handed` grouping has been removed, therefore we can calculate percent now: ``\
`  `[`mutate`](https://dplyr.tidyverse.org/reference/mutate.html)`(``n_col ``=`` `[`sum`](https://rdrr.io/r/base/sum.html)`(``c_count``)``, c_percent ``=`` ``c_count`` ``/`` ``n_col``)`\
`` # `summarise()` has regrouped the output. ``\
...
\
`full_dplyr`` ``<-`` `[`left_join`](https://dplyr.tidyverse.org/reference/mutate-joins.html)`(``c_h_df``, ``c_df``)`` ``|>`` `[`ungroup`](https://dplyr.tidyverse.org/reference/group_by.html)`(``)`\
...
\
`frm_rtables_h`` ``<-`` `[`cell_values`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(`\
`  ``tbl``,`\
`  rowpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"country"``, ``"CAN"``, ``"handed"``, ``"Right"``, ``"@content"``)``,`\
`  colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"arm"``, ``"Arm B"``, ``"gender"``, ``"Female"``)`\
`)``[[``1``]``]`\
`frm_rtables_h`\
`# [1] 20.0000000  0.2173913`\
\
`frm_dplyr_h`` ``<-`` ``full_dplyr`` ``|>`\
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``country`` ``==`` ``"CAN"`` ``&`` ``handed`` ``==`` ``"Right"`` ``&`` ``arm`` ``==`` ``"Arm B"`` ``&`` ``gender`` ``==`` ``"Female"``)`` ``|>`\
...
\
\
`frm_rtables_c`` ``<-`` `[`cell_values`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(`\
`  ``tbl``,`\
`  rowpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"country"``, ``"CAN"``, ``"@content"``)``,`\
`  colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"arm"``, ``"Arm A"``, ``"gender"``, ``"Male"``)`\
`)``[[``1``]``]`\
\
`frm_rtables_c`\
...
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``country`` ``==`` ``"CAN"`` ``&`` ``arm`` ``==`` ``"Arm A"`` ``&`` ``gender`` ``==`` ``"Male"``)`` ``|>`\
`  `[`select`](https://dplyr.tidyverse.org/reference/select.html)`(``c_count``, ``c_percent``)`\
\
`frm_dplyr_c`\
`# ``# A tibble: 2 × 2`\
`#   c_count c_percent`\
