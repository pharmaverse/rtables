...
\
`add_subgroup`` ``<-`` ``function``(``x``)`` `[`paste0`](https://rdrr.io/r/base/paste.html)`(`[`tolower`](https://rdrr.io/r/base/chartr.html)`(``x``)``, `[`sample`](https://rdrr.io/r/base/sample.html)`(``1``:``3``, `[`length`](https://rdrr.io/r/base/length.html)`(``x``)``, ``TRUE``)``)`\
\
[`set.seed`](https://rdrr.io/r/base/Random.html)`(``1``)`\
\
`df`` ``<-`` `[`tibble`](https://tibble.tidyverse.org/reference/tibble.html)`(`\
`  x ``=`` `[`rnorm`](https://rdrr.io/r/stats/Normal.html)`(``100``)``,`\
`  c1 ``=`` `[`factor`](https://rdrr.io/r/base/factor.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"A"``, ``"B"``, ``"C"``)``, ``100``, replace ``=`` ``TRUE``)``, levels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"A"``, ``"B"``, ``"C"``)``)``,`\
`  r1 ``=`` `[`factor`](https://rdrr.io/r/base/factor.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"U"``, ``"V"``, ``"W"``)``, ``100``, replace ``=`` ``TRUE``)``, levels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"U"``, ``"V"``, ``"W"``)``)`\
`)`` ``|>`\
`  `[`mutate`](https://dplyr.tidyverse.org/reference/mutate.html)`(`\
`    c2 ``=`` ``add_subgroup``(``c1``)``,`\
`    r2 ``=`` ``add_subgroup``(``r1``)``,`\
`    y ``=`` `[`as.numeric`](https://rdrr.io/r/base/numeric.html)`(``2`` ``*`` `[`as.numeric`](https://rdrr.io/r/base/numeric.html)`(``c1``)`` ``-`` ``3`` ``*`` `[`as.numeric`](https://rdrr.io/r/base/numeric.html)`(``r1``)``)`\
`  ``)`` ``|>`\
`  `[`select`](https://dplyr.tidyverse.org/reference/select.html)`(``c1``, ``c2``, ``r1``, ``r2``, ``x``, ``y``)`\
\
`df`\
`# ``# A tibble: 100 × 6`\
`#    c1    c2    r1    r2         x     y`\
...
\
`df_A`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``c1`` ``==`` ``"A"``)`\
`df_B`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``c1`` ``==`` ``"B"``)`\
`df_C`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``c1`` ``==`` ``"C"``)`
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``function``(``df``)`` ``foo``(``df``$``x``)``, var_labels ``=`` ``"foo label"``, format ``=`` ``"xx.xx"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``function``(``df``)`` ``bar``(``df``$``x``)``, var_labels ``=`` ``"bar label"``, format ``=`` ``"xx.xx"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``function``(``df``)`` ``zoo``(``df``$``x``)``, var_labels ``=`` ``"zoo label"``, format ``=`` ``"xx.xx"``)`\
\
`tbl`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``df``)`\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``foo``, var_labels ``=`` ``"foo label"``, format ``=`` ``"xx.xx"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``bar``, var_labels ``=`` ``"bar label"``, format ``=`` ``"xx.xx"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``zoo``, var_labels ``=`` ``"zoo label"``, format ``=`` ``"xx.xx"``)`\
\
`tbl2`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt2``, ``df``)`\
`# Warning: Non-unique sibling analysis table names. Using Labels instead. Use the table_names argument to analyze to avoid this when analyzing the same variable multiple times.`\
`#   occured at (row) path: root`\
`tbl2`\
`#              A       B       C  `\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``function``(``x``)`` ``{`\
`    `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`      ``"row 1"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`mean`](https://rdrr.io/r/base/mean.html)`(``x``)``, format ``=`` ``"xx.xx"``)``,`\
`      ``"row 2"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`sd`](https://rdrr.io/r/stats/sd.html)`(``x``)``, format ``=`` ``"xx.xxx"``)`\
`    ``)`\
`  ``}``, var_labels ``=`` ``"foo label"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``function``(``x``)`` ``{`\
`    `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`      ``"more rows 1"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`median`](https://rdrr.io/r/stats/median.html)`(``x``)``, format ``=`` ``"xx.x"``)``,`\
`      ``"even more rows 1"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`IQR`](https://rdrr.io/r/stats/IQR.html)`(``x``)``, format ``=`` ``"xx.xx"``)`\
`    ``)`\
`  ``}``, var_labels ``=`` ``"bar label"``, format ``=`` ``"xx.xx"``)`\
\
`tbl3`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt3``, ``df``)`\
`# Warning: Non-unique sibling analysis table names. Using Labels instead. Use the table_names argument to analyze to avoid this when analyzing the same variable multiple times.`\
`#   occured at (row) path: root`\
`tbl3`\
`#                        A       B       C  `\
...
\
`df_UA`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"U"``, ``c1`` ``==`` ``"A"``)`\
`df_VA`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"V"``, ``c1`` ``==`` ``"A"``)`\
`df_WA`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"W"``, ``c1`` ``==`` ``"A"``)`\
`df_UB`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"U"``, ``c1`` ``==`` ``"B"``)`\
`df_VB`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"V"``, ``c1`` ``==`` ``"B"``)`\
`df_WB`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"W"``, ``c1`` ``==`` ``"C"``)`\
`df_UC`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"U"``, ``c1`` ``==`` ``"C"``)`\
`df_VC`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"V"``, ``c1`` ``==`` ``"C"``)`\
`df_WC`` ``<-`` ``df`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"W"``, ``c1`` ``==`` ``"C"``)`
...
`  `[`paste`](https://rdrr.io/r/base/paste.html)`(`[`dim`](https://rdrr.io/r/base/dim.html)`(``df``)``, collapse ``=`` ``" x "``)`\
`}`
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``foo``)`\
\
`tbl4`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt4``, ``df``)`\
`tbl4`\
`#           A        B        C   `\
`# ————————————————————————————————`\
`# U                               `\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``cfun ``=`` ``foo``, format ``=`` ``"xx"``)`\
\
`tbl5`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt5``, ``df``)`\
`tbl5`\
`#      A        B        C   `\
`# ———————————————————————————`\
...
\
`foo`` ``<-`` ``function``(``df``, ``labelstr``)`` ``{`\
`  `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`paste`](https://rdrr.io/r/base/paste.html)`(`[`dim`](https://rdrr.io/r/base/dim.html)`(``df``)``, collapse ``=`` ``" x "``)``, format ``=`` ``"xx"``, label ``=`` ``labelstr``)`\
`}`\
\
`lyt6`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``cfun ``=`` ``foo``)`\
\
`tbl6`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt6``, ``df``)`\
`tbl6`\
`#       A        B        C   `\
`# ————————————————————————————`\
...
\
`foo`` ``<-`` ``function``(``df``, ``labelstr``)`` ``{`\
`  `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`mean`](https://rdrr.io/r/base/mean.html)`(``df``$``y``)``, label ``=`` ``labelstr``, format ``=`` ``"xx.xx"``)`\
`}`\
\
...
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``cfun ``=`` ``foo``)`\
\
`tbl7`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt7``, ``df``)`\
`tbl7`\
`#       A       B       C  `\
`# —————————————————————————`\
`# U   -1.00   1.00    3.00 `\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"y"``, afun ``=`` ``mean``)`\
\
`tbl8`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt8``, ``df``)`\
`tbl8`\
`#          A    B    C `\
`# —————————————————————`\
`# U                    `\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"y"``, afun ``=`` ``function``(``df``)`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``df``$``y``)``)`\
\
`tbl9`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt9``, ``df``)`\
`tbl9`\
`#       A    B    C `\
`# ——————————————————`\
`# U                 `\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"y"``, afun ``=`` ``function``(``x``)`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``x``)``)`\
\
`tbl10`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt10``, ``df``)`\
`tbl10`\
`#       A    B    C `\
`# ——————————————————`\
`# U                 `\
...
\
`df`` ``|>`\
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``r1`` ``==`` ``"U"``, ``r2`` ``==`` ``"u1"``, ``c1`` ``==`` ``"A"``)`\
`# ``# A tibble: 2 × 6`\
`#   c1    c2    r1    r2        x     y`\
`#   ``<fct>`` ``<chr>`` ``<fct>`` ``<chr>`` ``<dbl>`` ``<dbl>`\
`# ``1`` A     a2    U     u1    1.12     -``1`\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r2"``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``cfun ``=`` ``function``(``df``, ``labelstr``)`` ``{`\
`    `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`mean`](https://rdrr.io/r/base/mean.html)`(``df``$``x``)``, format ``=`` ``"xx.xx"``, label ``=`` `[`paste`](https://rdrr.io/r/base/paste.html)`(``"mean x for"``, ``labelstr``)``)`\
`  ``}``)`\
\
`tbl11`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt11``, ``df``)`\
`tbl11`\
`#                     A       B       C  `\
`# ———————————————————————————————————————`\
`# U                                      `\
...
`  `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(``"mean (sd)"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(`[`mean`](https://rdrr.io/r/base/mean.html)`(``x``)``, `[`sd`](https://rdrr.io/r/stats/sd.html)`(``x``)``)``, format ``=`` ``"xx.xx (xx.xx)"``)``)`\
`}`\
\
`s_range`` ``<-`` ``function``(``x``)`` ``{`\
`  `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(``"range"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`range`](https://rdrr.io/r/base/range.html)`(``x``)``, format ``=`` ``"xx.xx - xx.xx"``)``)`\
`}`\
\
`lyt12`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r2"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``s_mean_sd``, show_labels ``=`` ``"hidden"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``s_range``, show_labels ``=`` ``"hidden"``)`\
\
`tbl12`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt12``, ``df``)`\
`# Warning: Non-unique sibling analysis table names. Using Labels instead. Use the table_names argument to analyze to avoid this when analyzing the same variable multiple times.`\
...
`  `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`nrow`](https://rdrr.io/r/base/nrow.html)`(``df``)``, format ``=`` ``"xx"``, label ``=`` `[`paste`](https://rdrr.io/r/base/paste.html)`(``labelstr``, ``"(n)"``)``)`\
`}`\
\
`lyt13`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r2"``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``cfun ``=`` ``s_cfun_2``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``s_mean_sd``, show_labels ``=`` ``"hidden"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``s_range``, show_labels ``=`` ``"hidden"``)`\
\
`tbl13`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt13``, ``df``)`\
`# Warning: Non-unique sibling analysis table names. Using Labels instead. Use the table_names argument to analyze to avoid this when analyzing the same variable multiple times.`\
`#   occured at (row) path: r1[U]->r2[u3]`\
`# Modifying subtable (or row) names to ensure uniqueness among direct siblings`\
`# [x  -> { x, x[2] }]`\
...
\
`lyt14`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"c1"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r1"``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``cfun ``=`` ``s_cfun_2``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"r2"``)`` ``|>`\
...
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"x"``, ``s_range``, show_labels ``=`` ``"hidden"``)`\
\
`tbl14`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt14``, ``df``)`\
`# Warning: Non-unique sibling analysis table names. Using Labels instead. Use the table_names argument to analyze to avoid this when analyzing the same variable multiple times.`\
`#   occured at (row) path: r1[U]->r2[u3]`\
`# Modifying subtable (or row) names to ensure uniqueness among direct siblings`\
`# [x  -> { x, x[2] }]`\
