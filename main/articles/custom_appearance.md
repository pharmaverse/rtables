...
documentation page
[`help("decimal_align")`](https://pharmaverse.github.io/formatters/latest-tag/reference/decimal_align.html).
...
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``function``(``x``)`` ``{`\
`    `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`      left ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(``"l"``, align ``=`` ``"left"``)``,`\
`      right ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(``"r"``, align ``=`` ``"right"``)``,`\
`      center ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(``"c"``, align ``=`` ``"center"``)`\
`    ``)`\
`  ``}``)`\
\
...
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``function``(``x``)`` ``{`\
`    `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`      left ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(``"l"``)``,`\
`      right ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(``"r"``)``,`\
`      center ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(``"c"``)``,`\
`      .aligns ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"right"``)`\
`    ``)`` ``# NB: .aligns = c("right", "left", "center")`\
`  ``}``)`\
\
`tbl2`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt2``, ``DM``)`\
`tbl2`\
`#          all obs`\
`# ————————————————`\
`# left           l`\
...
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"AGE"``, ``"STRATA1"``)``, ``function``(``x``)`` ``{`\
...
`        .formats ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"xx.x"``)``, .aligns ``=`` ``"left"`\
`      ``)`\
`    ``}`` ``else`` ``if`` ``(`[`is.factor`](https://rdrr.io/r/base/factor.html)`(``x``)``)`` ``{`\
`      `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`length`](https://rdrr.io/r/base/length.html)`(`[`unique`](https://rdrr.io/r/base/unique.html)`(``x``)``)``, align ``=`` ``"right"``)`\
`    ``}`` ``else`` ``{`\
`      `[`stop`](https://rdrr.io/r/base/stop.html)`(``"Unsupported type"``)`\
`    ``}`\
`  ``}``, show_labels ``=`` ``"visible"``, na_str ``=`` ``"NE"``)`\
\
`tbl3`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt3``, ``ex_adsl``)`\
`tbl3`\
...
`  `[`append_topleft`](https://pharmaverse.github.io/rtables/reference/append_topleft.md)`(``"New top_left material here"``)`\
\
...
`lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``, label_pos ``=`` ``"topleft"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"SEX"``, label_pos ``=`` ``"topleft"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``)`\
\
[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``DM``)`\
`# STRATA1                                                     `\
...
`    ``}`\
`  ``}``, show_labels ``=`` ``"visible"``, na_str ``=`` ``"NE"``)`` ``|>`\
`  `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``ex_adsl``)`\
\
`# Adding top-left material`\
[`top_left`](https://pharmaverse.github.io/rtables/reference/top_left.md)`(``lyt``)`` ``<-`` ``"New top-left material here"`\
\
`lyt`\
...
\
`lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``inset ``=`` ``5``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``)`\
\
[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``DM``)`\
`#             all obs`\
...
\
[`table_inset`](https://pharmaverse.github.io/formatters/latest-tag/reference/table_inset.html)`(``tbl``)`` ``<-`` ``5`\
`tbl`\
`#             all obs`\
`#      ——————————————`\
`#      Mean    34.22`
...
`  `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`    row1 ``=`` ``5``,`\
`    row2 ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``2``)``,`\
`    .row_footnotes ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``row1 ``=`` ``"row 1 rfn"``)``,`\
`    .cell_footnotes ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``row2 ``=`` ``"row 2 cfn"``)`\
`  ``)`\
`}`\
\
`lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(`\
...
`)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, afun ``=`` ``analysisfun``)`\
\
`result`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``ex_adsl``)`\
`result`\
`# Title says Whaaaat`\
`# Oh, ok.`\
`# `\
...
\
[`table_inset`](https://pharmaverse.github.io/formatters/latest-tag/reference/table_inset.html)`(``result``)`` ``<-`` ``5`\
`result`\
`# Title says Whaaaat`\
`# Oh, ok.`\
`# `\
...
\
`tbl`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"Species"``)`` ``|>`\
`  `[`add_colcounts`](https://pharmaverse.github.io/rtables/reference/add_colcounts.md)`(``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"Sepal.Length"``, ``"Petal.Width"``)``, ``function``(``x``)`` ``{`\
`    `[`in_rows`](https://pharmaverse.github.io/rtables/reference/in_rows.md)`(`\
`      mean_sd ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`[`mean`](https://rdrr.io/r/base/mean.html)`(``x``)``, `[`sd`](https://rdrr.io/r/stats/sd.html)`(``x``)``)``,`\
`      var ``=`` `[`var`](https://rdrr.io/r/stats/cor.html)`(``x``)``,`\
`      min_max ``=`` `[`range`](https://rdrr.io/r/base/range.html)`(``x``)``,`\
`      .formats ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"xx.xx (xx.xx)"``, ``"xx.xxx"``, ``"xx.x - xx.x"``)``,`\
`      .labels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Mean (sd)"``, ``"Variance"``, ``"Min - Max"``)`\
`    ``)`\
`  ``}``)`` ``|>`\
`  `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``iris``, hsep ``=`` ``"="``)`\
`tbl`\
...
`lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"Species"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(`[`head`](https://pharmaverse.github.io/rtables/reference/head_tail.md)`(`[`names`](https://rdrr.io/r/base/names.html)`(``iris``)``, ``-``1``)``, afun ``=`` ``function``(``x``)`` ``{`\
...
`      ``"range"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`diff`](https://rdrr.io/r/base/diff.html)`(`[`range`](https://rdrr.io/r/base/range.html)`(``x``)``)``, format ``=`` ``"xx.xx"``)`\
`    ``)`\
`  ``}``, section_div ``=`` ``"+"``)`\
\
[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``iris``)`\
`#                  setosa      versicolor     virginica `\
`# ——————————————————————————————————————————————————————`\
`# Sepal.Length                                          `\
`#   mean / sd    5.01 (0.35)   5.94 (0.52)   6.59 (0.64)`\
...
`lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"RACE"``, section_div ``=`` ``"="``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``, section_div ``=`` ``"~"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``mean``, var_labels ``=`` ``"Age"``, format ``=`` ``"xx.xx"``)`\
\
[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``DM``)`\
`#                                             A: Drug X   B: Placebo   C: Combination`\
`# ———————————————————————————————————————————————————————————————————————————————————`\
...
`  subtitles ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"subtitle YYYYYYYYYY"``, ``"subtitle2 ZZZZZZZZZ"``)``,`\
...
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"SEX"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``mean``, format ``=`` ``"xx.x"``)`` ``|>`\
...
`)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"SEX"``, indent_mod ``=`` ``3``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``, indent_mod ``=`` ``5``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``mean``, format ``=`` ``"xx.x"``)`` ``|>`\
`  `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``DM``)`\
`# Study XXXXXXXX`\
`# subtitle YYYYYYYYYY`\
...
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``mean``, show_labels ``=`` ``"default"``)`\
\
[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``DM``)`\
`#               A: Drug X          B: Placebo       C: Combination `\
`#                (N=121)            (N=106)            (N=129)     `\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``var ``=`` ``"ARM"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"SEX"``, split_fun ``=`` ``drop_split_levels``, child_labels ``=`` ``"hidden"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``mean``, show_labels ``=`` ``"visible"``)`\
\
[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt2``, ``DM``)`\
`#               A: Drug X          B: Placebo       C: Combination `\
`#                (N=121)            (N=106)            (N=129)     `\
`# —————————————————————————————————————————————————————————————————`\
`# A                                                                `\
...
`)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"SEX"``, split_fun ``=`` ``drop_split_levels``, label_pos ``=`` ``"visible"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``, label_pos ``=`` ``"hidden"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``mean``, format ``=`` ``"xx.x"``)`` ``|>`\
`  `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``DM``)`\
`# Study XXXXXXXX`\
`# subtitle YYYYYYYYYY`\
...
`)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"SEX"``, split_fun ``=`` ``drop_split_levels``, label_pos ``=`` ``"topleft"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``, label_pos ``=`` ``"hidden"``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, ``mean``, format ``=`` ``"xx.x"``)`` ``|>`\
`  `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``DM``)`\
`# Study XXXXXXXX`\
...
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``SEX`` `[`%in%`](https://rdrr.io/r/base/match.html)` `[`c`](https://rdrr.io/r/base/c.html)`(``"M"``, ``"F"``)``)`` ``|>`\
`  `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``RACE`` `[`%in%`](https://rdrr.io/r/base/match.html)` `[`levels`](https://rdrr.io/r/base/levels.html)`(``RACE``)``[``1``:``2``]``)`\
\
[`levels`](https://rdrr.io/r/base/levels.html)`(``trimmed_data``$``ARM``)``[``1``]`` ``<-`` ``"Incredibly long column name to be wrapped"`\
[`levels`](https://rdrr.io/r/base/levels.html)`(``trimmed_data``$``ARM``)``[``2``]`` ``<-`` ``"This_column_name_should_be_split_somewhere"`\
\
`wide_tbl`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(`\
...
`)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"RACE"``, split_fun ``=`` ``drop_split_levels``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(`\
`    `[`c`](https://rdrr.io/r/base/c.html)`(``"AGE"``, ``"EOSDY"``)``,`\
`    na_str ``=`` ``"Very long cell contents to_be_wrapped_and_splitted"``,`\
`    inclNAs ``=`` ``TRUE`\
`  ``)`` ``|>`\
`  `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``trimmed_data``)`\
\
`wide_tbl`\
...
\
`result_wrap_cells`` ``<-`` `[`toString`](https://pharmaverse.github.io/formatters/latest-tag/reference/tostring.html)`(``wide_tbl``, widths ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``10``, ``8``, ``8``, ``8``)``)`\
`matrix_wrap_cells`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`[`strsplit`](https://rdrr.io/r/base/strsplit.html)`(``result_wrap_cells``, ``"\n"``)``[[``1``]``]``, ncol ``=`` ``1``)`\
`matrix_wrap_cells`\
`#       [,1]                                                                         `\
...
\
`result_wrap_cells_tf`` ``<-`` `[`toString`](https://pharmaverse.github.io/formatters/latest-tag/reference/tostring.html)`(`\
`  ``wide_tbl``,`\
`  widths ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``10``, ``8``, ``8``, ``8``)``,`\
`  tf_wrap ``=`` ``TRUE``,`\
`  max_width ``=`` ``43`\
`)`\
`matrix_wrap_cells_tf`` ``<-`` `[`matrix`](https://rdrr.io/r/base/matrix.html)`(`[`strsplit`](https://rdrr.io/r/base/strsplit.html)`(``result_wrap_cells_tf``, ``"\n"``)``[[``1``]``]``, ncol ``=`` ``1``)`\
