...
\
`raw_lyt`` ``<-`` `[`basic_table`](https://pharmaverse.github.io/rtables/reference/basic_table.md)`(``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"SEX"``)`` ``|>`\
...
\
`raw_tbl`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``raw_lyt``, ``DM``)`\
`raw_tbl`\
...
\
[`trim_rows`](https://pharmaverse.github.io/rtables/reference/trim_rows.md)`(``raw_tbl``)`\
`#                                                  A: Drug X                                              B: Placebo                                           C: Combination                   `\
`#                                 F            M           U      UNDIFFERENTIATED       F            M           U      UNDIFFERENTIATED       F            M           U      UNDIFFERENTIATED`\
`# ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————`\
`# ASIAN                       44 (62.9%)   35 (68.6%)   0 (NA%)       0 (NA%)        37 (66.1%)   31 (62.0%)   0 (NA%)       0 (NA%)        40 (65.6%)   44 (64.7%)   0 (NA%)       0 (NA%)     `\
...
\
`coltrimmed`` ``<-`` ``raw_tbl``[``, `[`col_counts`](https://pharmaverse.github.io/rtables/reference/col_accessors.md)`(``raw_tbl``)`` ``>`` ``0``]`\
...
`h_coltrimmed`` ``<-`` `[`head`](https://pharmaverse.github.io/rtables/reference/head_tail.md)`(``coltrimmed``, n ``=`` ``14``)`\
`h_coltrimmed`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
...
\
[`table_structure`](https://pharmaverse.github.io/rtables/reference/table_structure.md)`(``h_coltrimmed``)`\
`# [TableTree] RACE`\
...
\
[`row_paths_summary`](https://pharmaverse.github.io/rtables/reference/row_paths_summary.md)`(``h_coltrimmed``)`\
...
\
`pruned`` ``<-`` `[`prune_table`](https://pharmaverse.github.io/rtables/reference/prune_table.md)`(``coltrimmed``)`\
`pruned`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
...
\
`pruned2`` ``<-`` `[`prune_table`](https://pharmaverse.github.io/rtables/reference/prune_table.md)`(``coltrimmed``, `[`low_obs_pruner`](https://pharmaverse.github.io/rtables/reference/trim_prune_funs.md)`(``10``, ``"mean"``)``)`\
`pruned2`\
`#                   A: Drug X                B: Placebo              C: Combination     `\
`#                F            M            F            M            F            M     `\
`# ——————————————————————————————————————————————————————————————————————————————————————`\
...
\
`pruned3`` ``<-`` `[`prune_table`](https://pharmaverse.github.io/rtables/reference/prune_table.md)`(``coltrimmed``, `[`low_obs_pruner`](https://pharmaverse.github.io/rtables/reference/trim_prune_funs.md)`(``10``, ``"sum"``)``, stop_depth ``=`` ``1``)`\
`pruned3`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
...
\
`pruned4`` ``<-`` `[`prune_table`](https://pharmaverse.github.io/rtables/reference/prune_table.md)`(``coltrimmed``, `[`low_obs_pruner`](https://pharmaverse.github.io/rtables/reference/trim_prune_funs.md)`(``16``, ``"sum"``)``)`\
`pruned4`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
...
\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``pruned``, path ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"ASIAN"``, ``"STRATA1"``)``, scorefun ``=`` ``cont_n_allcols``)`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
`# ASIAN                       44 (62.9%)   35 (68.6%)   37 (66.1%)   31 (62.0%)   40 (65.6%)   44 (64.7%)`\
...
\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``pruned``, path ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"*"``, ``"STRATA1"``)``, scorefun ``=`` ``cont_n_allcols``)`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
`# ASIAN                       44 (62.9%)   35 (68.6%)   37 (66.1%)   31 (62.0%)   40 (65.6%)   44 (64.7%)`\
...
\
`tmptbl`` ``<-`` `[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``pruned``, path ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"ASIAN"``, ``"STRATA1"``)``, scorefun ``=`` ``cont_n_allcols``)`\
`tmptbl`` ``<-`` `[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``tmptbl``, path ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"BLACK OR AFRICAN AMERICAN"``, ``"STRATA1"``)``, scorefun ``=`` ``cont_n_allcols``)`\
`tmptbl`` ``<-`` `[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``tmptbl``, path ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"WHITE"``, ``"STRATA1"``)``, scorefun ``=`` ``cont_n_allcols``)`\
`tmptbl`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
...
\
[`table_structure`](https://pharmaverse.github.io/rtables/reference/table_structure.md)`(``pruned``)`\
`# [TableTree] RACE`\
`#  [TableTree] ASIAN [cont: 1 x 6]`\
`#   [TableTree] STRATA1`\
`#    [TableTree] A [cont: 1 x 6]`\
...
\
[`row_paths_summary`](https://pharmaverse.github.io/rtables/reference/row_paths_summary.md)`(``pruned``)`\
`# rowname                      node_class    path                                                                `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————————————`\
`# ASIAN                        ContentRow    RACE, ASIAN, @content, ASIAN                                        `\
`#   A                          ContentRow    RACE, ASIAN, STRATA1, A, @content, A                                `\
...
\
`ethsort`` ``<-`` `[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``pruned``, path ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``)``, scorefun ``=`` ``cont_n_allcols``, decreasing ``=`` ``FALSE``)`\
`ethsort`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
...
\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``pruned``, path ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"*"``, ``"STRATA1"``)``, `[`cont_n_onecol`](https://pharmaverse.github.io/rtables/reference/score_funs.md)`(``5``)``)`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
`# ASIAN                       44 (62.9%)   35 (68.6%)   37 (66.1%)   31 (62.0%)   40 (65.6%)   44 (64.7%)`\
...
`    ``"median"`` ``=`` `[`median`](https://rdrr.io/r/stats/median.html)`(``x``)``,`\
`    ``"mean"`` ``=`` `[`mean`](https://rdrr.io/r/base/mean.html)`(``x``)``,`\
`    .formats ``=`` ``"xx.x"`\
`  ``)`\
`}`\
\
...
`    ``"RACE"``,`\
`    split_fun ``=`` `[`drop_and_remove_levels`](https://pharmaverse.github.io/rtables/reference/split_funcs.md)`(``"WHITE"``)`` ``# dropping WHITE levels`\
`  ``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``)`` ``|>`\
`  `[`split_rows_by`](https://pharmaverse.github.io/rtables/reference/split_rows_by.md)`(``"STRATA1"``)`` ``|>`\
`  `[`summarize_row_groups`](https://pharmaverse.github.io/rtables/reference/summarize_row_groups.md)`(``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, afun ``=`` ``more_analysis_fnc``)`\
\
`tbl`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``raw_lyt``, ``DM``)`` ``|>`\
...
\
[`table_structure`](https://pharmaverse.github.io/rtables/reference/table_structure.md)`(``tbl``)`` ``# Direct inspection into the tree-like structure of rtables`\
`# [TableTree] RACE`\
...
`  `[`sum`](https://rdrr.io/r/base/sum.html)`(`[`unlist`](https://rdrr.io/r/base/unlist.html)`(`[`row_values`](https://pharmaverse.github.io/rtables/reference/row_accessors.md)`(``tt``)``)``)`\
`}`\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``tbl``, `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"*"``, ``"STRATA1"``, ``"*"``, ``"AGE"``)``, ``scorefun``)`\
`#                             A: Drug X    B: Placebo   C: Combination`\
`# ————————————————————————————————————————————————————————————————————`\
`# ASIAN                       79 (65.3%)   68 (64.2%)     84 (65.1%)  `\
`#   A                         27 (22.3%)   20 (18.9%)     31 (24.0%)  `\
...
`  ``function``(``tt``)`` ``{`\
`    ``# Here we could use browser()`\
`    `[`unlist`](https://rdrr.io/r/base/unlist.html)`(`[`cell_values`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(``tt``, colpath ``=`` ``colpath``)``, use.names ``=`` ``FALSE``)``[``1``]`` ``# Modified to lose the list names`\
`  ``}`\
`}`\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``tbl``, `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"*"``, ``"STRATA1"``, ``"*"``, ``"AGE"``)``, ``scorefun_onecol``(``colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"A: Drug X"``)``)``)`\
`#                             A: Drug X    B: Placebo   C: Combination`\
`# ————————————————————————————————————————————————————————————————————`\
`# ASIAN                       79 (65.3%)   68 (64.2%)     84 (65.1%)  `\
`#   A                         27 (22.3%)   20 (18.9%)     31 (24.0%)  `\
...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARM"``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"SEX"``,`\
`    split_fun ``=`` `[`drop_and_remove_levels`](https://pharmaverse.github.io/rtables/reference/split_funcs.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"U"``, ``"UNDIFFERENTIATED"``)``)`\
`  ``)`` ``|>`\
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(``"AGE"``, afun ``=`` ``more_analysis_fnc``)`` ``|>`\
...
\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``tbl``, `[`c`](https://rdrr.io/r/base/c.html)`(``"AGE"``)``, ``scorefun_onecol``(``colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"B: Placebo"``, ``"SEX"``, ``"F"``)``)``)`\
`#           A: Drug X      B: Placebo      C: Combination  `\
`#            F      M       F       M        F         M   `\
`# —————————————————————————————————————————————————————————`\
`# mean     33.7    36.5   33.8    32.1     34.9      34.3  `\
...
`  ``nm`` ``<-`` `[`obj_name`](https://pharmaverse.github.io/formatters/latest-tag/reference/lab_name.html)`(``tt``)`\
`  `[`print`](https://rdrr.io/r/base/print.html)`(``nm``)`\
`  ``nm`\
`}`\
\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``ethsort``, ``"RACE"``, ``silly_name_scorer``)`` ``# Now, it is sorted alphabetically!`\
`# [1] "WHITE"`\
...
`  ``rpath`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(`[`obj_name`](https://pharmaverse.github.io/formatters/latest-tag/reference/lab_name.html)`(``tt``)``, ``"@content"``, `[`obj_name`](https://pharmaverse.github.io/formatters/latest-tag/reference/lab_name.html)`(``tt``)``)`\
`  ``## the [1] below is cause these are count (pct%) cells`\
`  ``## and we only want the count part!`\
`  ``mcount`` ``<-`` `[`unlist`](https://rdrr.io/r/base/unlist.html)`(`[`cell_values`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(`\
`    ``tt``,`\
`    rowpath ``=`` ``rpath``,`\
`    colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"C: Combination"``, ``"SEX"``, ``"M"``)`\
`  ``)``)``[``1``]`\
`  ``fcount`` ``<-`` `[`unlist`](https://rdrr.io/r/base/unlist.html)`(`[`cell_values`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(`\
`    ``tt``,`\
`    rowpath ``=`` ``rpath``,`\
`    colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"C: Combination"``, ``"SEX"``, ``"F"``)`\
`  ``)``)``[``1``]`\
`  ``(``mcount`` ``-`` ``fcount``)`` ``/`` ``fcount`\
`}`\
\
[`sort_at_path`](https://pharmaverse.github.io/rtables/reference/sort_at_path.md)`(``pruned``, `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"*"``, ``"STRATA1"``)``, ``silly_gender_diffcount``)`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
`# ASIAN                       44 (62.9%)   35 (68.6%)   37 (66.1%)   31 (62.0%)   40 (65.6%)   44 (64.7%)`\
