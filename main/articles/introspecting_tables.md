...
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"ARMCD"``, show_colcounts ``=`` ``TRUE``, colcount_format ``=`` ``"N=xx"``)`` ``|>`\
`  `[`split_cols_by`](https://pharmaverse.github.io/rtables/reference/split_cols_by.md)`(``"STRATA2"``, show_colcounts ``=`` ``TRUE``)`` ``|>`\
...
\
[`dim`](https://rdrr.io/r/base/dim.html)`(``tbl``)`\
`# [1] 6 7`\
[`nrow`](https://rdrr.io/r/base/nrow.html)`(``tbl``)`\
`# [1] 6`\
[`ncol`](https://rdrr.io/r/base/nrow.html)`(``tbl``)`\
`# [1] 7`
...
\
[`table_structure`](https://pharmaverse.github.io/rtables/reference/table_structure.md)`(``tbl``, detail ``=`` ``"row"``)`` ``# or "subtable"`\
...
\
[`coltree_structure`](https://pharmaverse.github.io/rtables/reference/coltree_structure.md)`(``tbl``)`\
`# [root] (no pos)`\
`#    [ARMCD] (no pos)`\
`#      [ARM A] (ARMCD: ARM A)`\
...
\
[`make_row_df`](https://pharmaverse.github.io/formatters/latest-tag/reference/make_row_df.html)`(``tbl``)``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"label"``, ``"name"``, ``"abs_rownumber"``, ``"path"``, ``"node_class"``)``]`\
...
\
[`row_paths`](https://pharmaverse.github.io/rtables/reference/make_col_row_df.md)`(``tbl``)`\
`# [[1]]`\
...
\
[`make_row_df`](https://pharmaverse.github.io/formatters/latest-tag/reference/make_row_df.html)`(``tbl``, visible_only ``=`` ``FALSE``)``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"label"``, ``"name"``, ``"abs_rownumber"``, ``"path"``, ``"node_class"``)``]`\
`#    label      name abs_rownumber         path      node_class`\
...
\
[`make_col_df`](https://pharmaverse.github.io/rtables/reference/make_col_df.md)`(``tbl``)``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"label"``, ``"name"``, ``"abs_pos"``, ``"path"``, ``"leaf_indices"``)``]`\
...
\
[`make_col_df`](https://pharmaverse.github.io/rtables/reference/make_col_df.md)`(``tbl``, visible_only ``=`` ``FALSE``)``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"label"``, ``"name"``, ``"abs_pos"``, ``"path"``, ``"leaf_indices"``)``]`\
`#    label  name abs_pos         path leaf_indices`\
...
\
[`col_paths`](https://pharmaverse.github.io/rtables/reference/make_col_row_df.md)`(``tbl``)`\
`# [[1]]`\
...
\
[`table_shell`](https://pharmaverse.github.io/rtables/reference/table_shell.md)`(``tbl``)`\
`#                  ARM A                     ARM B                     ARM C                      `\
`#                  N=134                     N=134                     N=132                      `\
`#             S1           S2           S1           S2           S1           S2                 `\
`#           (N=73)       (N=61)       (N=67)       (N=67)       (N=56)       (N=76)        All    `\
...
\
[`value_formats`](https://pharmaverse.github.io/rtables/reference/value_formats.md)`(``tbl``)`\
