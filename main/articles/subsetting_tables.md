...
\
`tbl`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt``, ``ex_adsl`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``SEX`` `[`%in%`](https://rdrr.io/r/base/match.html)` `[`c`](https://rdrr.io/r/base/c.html)`(``"M"``, ``"F"``)``)``)`\
`tbl`\
...
\
`tbl``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"A: Drug X"``)``]`\
...
\
[`top_left`](https://pharmaverse.github.io/rtables/reference/top_left.md)`(``tbl``)`` ``<-`` ``"SEX"`\
[`main_title`](https://pharmaverse.github.io/formatters/latest-tag/reference/title_footer.html)`(``tbl``)`` ``<-`` ``"Table 1"`\
[`subtitles`](https://pharmaverse.github.io/formatters/latest-tag/reference/title_footer.html)`(``tbl``)`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Authors:"``, ``" - Abcd Zabcd"``, ``" - Cde Zbcd"``)`\
\
[`main_footer`](https://pharmaverse.github.io/formatters/latest-tag/reference/title_footer.html)`(``tbl``)`` ``<-`` ``"Please regard this table as an example of smart subsetting"`\
[`prov_footer`](https://pharmaverse.github.io/formatters/latest-tag/reference/title_footer.html)`(``tbl``)`` ``<-`` ``"Do remember where you read this though"`\
\
`fnotes_at_path``(``tbl``, rowpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"M"``, ``"AGE"``, ``"Mean"``)``, colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"A: Drug X"``)``)`` ``<-`` ``"Very important mean"`
...
`# ————————————————`\
[`col_paths_summary`](https://pharmaverse.github.io/rtables/reference/row_paths_summary.md)`(``tbl``)`` ``# Use these to find the right path to value or label`\
`# label             path               `\
`# —————————————————————————————————————`\
`# A: Drug X         ARM, A: Drug X     `\
`# B: Placebo        ARM, B: Placebo    `\
`# C: Combination    ARM, C: Combination`\
[`row_paths_summary`](https://pharmaverse.github.io/rtables/reference/row_paths_summary.md)`(``tbl``)`` ``#`\
...
`fnotes_at_path``(``tbl``, rowpath ``=`` ``NULL``, colpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"A: Drug X"``)``)`` ``<-`` ``"Interesting"`\
`tbl``[``3``, ``1``]`\
`#        A: Drug X {1}`\
`# ————————————————————`\
`# Mean       32.76    `\
...
`fnotes_at_path``(``tbl``, rowpath ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"M"``, ``"AGE"``, ``"Mean"``)``, colpath ``=`` ``NULL``)`` ``<-`` ``"THIS mean"`\
...
`  `[`analyze`](https://pharmaverse.github.io/rtables/reference/analyze.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"AGE"``, ``"STRATA1"``)``)`\
\
`tbl2`` ``<-`` `[`build_table`](https://pharmaverse.github.io/rtables/reference/build_table.md)`(``lyt2``, ``ex_adsl`` ``|>`` `[`filter`](https://dplyr.tidyverse.org/reference/filter.html)`(``SEX`` `[`%in%`](https://rdrr.io/r/base/match.html)` `[`c`](https://rdrr.io/r/base/c.html)`(``"M"``, ``"F"``)`` ``&`` ``RACE`` `[`%in%`](https://rdrr.io/r/base/match.html)` ``(`[`levels`](https://rdrr.io/r/base/levels.html)`(``RACE``)``[``1``:``3``]``)``)``)`\
`tbl2`\
`#                                    A: Drug X                B: Placebo              C: Combination     `\
`#                                 F            M            F            M            F            M     `\
`# ———————————————————————————————————————————————————————————————————————————————————————————————————————`\
...
\
[`col_paths_summary`](https://pharmaverse.github.io/rtables/reference/row_paths_summary.md)`(``tbl2``)`\
`# label             path                       `\
`# —————————————————————————————————————————————`\
`# A: Drug X         ARM, A: Drug X             `\
...
\
`tbl2``[`[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"ASIAN"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"C: Combination"``)``]`\
`#                 C: Combination     `\
`#                 F            M     `\
`# ———————————————————————————————————`\
...
\
[`value_at`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(``tbl2``, `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"ASIAN"``, ``"AGE"``, ``"Mean"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"A: Drug X"``, ``"SEX"``, ``"F"``)``)`\
`# [1] 31.21951`
...
\
[`cell_values`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(``tbl2``, `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"ASIAN"``, ``"AGE"``, ``"Mean"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"A: Drug X"``)``)`\
`` # $`A: Drug X.F` ``\
`# [1] 31.21951`\
`# `\
`` # $`A: Drug X.M` ``\
...
\
[`cell_values`](https://pharmaverse.github.io/rtables/reference/cell_values.md)`(``tbl2``, `[`c`](https://rdrr.io/r/base/c.html)`(``"RACE"``, ``"ASIAN"``, ``"AGE"``, ``"Mean"``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"A: Drug X"``, ``"SEX"``, ``"F"``)``)`\
`` # $`A: Drug X.F` ``\
`# [1] 31.21951`
