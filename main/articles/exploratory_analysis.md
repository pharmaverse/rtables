...
\
[`table`](https://rdrr.io/r/base/table.html)`(``ex_adsl``$``ARM``)`\
`# `\
`#      A: Drug X     B: Placebo C: Combination `\
`#            134            134            132`\
[`table`](https://rdrr.io/r/base/table.html)`(``ex_adsl``$``SEX``, ``ex_adsl``$``ARM``)`\
`#                   `\
`#                    A: Drug X B: Placebo C: Combination`\
`#   F                       79         77             66`\
`#   M                       51         55             60`\
...
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, col_vars ``=`` ``"ARM"``)`\
`#         A: Drug X   B: Placebo   C: Combination`\
`#          (N=134)     (N=134)        (N=132)    `\
`# ———————————————————————————————————————————————`\
`# count      134         134            132`\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, col_vars ``=`` ``"ARM"``, row_vars ``=`` ``"SEX"``)`\
`#                    A: Drug X   B: Placebo   C: Combination`\
...
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, ``"ARM"``, show_colcounts ``=`` ``FALSE``)`\
`# count            all obs`\
`# ————————————————————————`\
`# A: Drug X          134  `\
`# B: Placebo         134  `\
...
\
`tmp_adsl`` ``<-`` ``ex_adsl`\
`tmp_adsl``$``new`` ``<-`` `[`rep_len`](https://rdrr.io/r/base/rep.html)`(`[`c`](https://rdrr.io/r/base/c.html)`(``""``, ``"A"``, ``"B"``)``, `[`nrow`](https://rdrr.io/r/base/nrow.html)`(``tmp_adsl``)``)`\
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``tmp_adsl``, row_vars ``=`` ``"new"``)`
...
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, row_vars ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"SEX"``, ``"STRATA1"``)``, col_vars ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"STRATA2"``)``)`\
`#                       A: Drug X        B: Placebo       C: Combination  `\
`#                      S1       S2       S1       S2       S1        S2   `\
...
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(`\
`  ``ex_adsl``,`\
`  row_vars ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"SEX"``, ``"STRATA1"``)``,`\
`  col_vars ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"ARM"``, ``"STRATA2"``)``,`\
`  drop_levels ``=`` ``FALSE`\
`)`\
`#                       A: Drug X        B: Placebo       C: Combination  `\
`#                      S1       S2       S1       S2       S1        S2   `\
...
\
[`table`](https://rdrr.io/r/base/table.html)`(``ex_adsl``$``SEX``, ``ex_adsl``$``STRATA1``, ``ex_adsl``$``ARM``, ``ex_adsl``$``STRATA2``)`\
`# , ,  = A: Drug X,  = S1`\
`# `\
`#                   `\
`#                     A  B  C`\
...
\
`t1`` ``<-`` `[`ftable`](https://rdrr.io/r/stats/ftable.html)`(``ex_adsl``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``"SEX"``, ``"STRATA1"``, ``"ARM"``, ``"STRATA2"``)``]``)`\
[`ftable`](https://rdrr.io/r/stats/ftable.html)`(``t1``, row.vars ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"SEX"``, ``"STRATA1"``)``)`\
...
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``tmp_adsl``, row_vars ``=`` ``"ARM"``, col_vars ``=`` ``"SEX"``)`\
...
\
`# Recode NA values`\
`tmp_adsl``[[``1``]``]`` ``<-`` `[`addNA`](https://rdrr.io/r/base/factor.html)`(``tmp_adsl``[[``1``]``]``)`\
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``tmp_adsl``, row_vars ``=`` ``"ARM"``, col_vars ``=`` ``"SEX"``)`\
`#                     F         M        U     UNDIFFERENTIATED`\
`# count            (N=222)   (N=166)   (N=9)        (N=3)      `\
...
\
`tmp_adsl``$``new1`` ``<-`` `[`factor`](https://rdrr.io/r/base/factor.html)`(``NA_character_``, levels ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"X"``, ``"Y"``, ``"Z"``)``)`\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``tmp_adsl``, row_vars ``=`` ``"ARM"``, col_vars ``=`` ``"new1"``)`\
`#                    X       Y       Z  `\
`# count            (N=0)   (N=0)   (N=0)`\
`# ——————————————————————————————————————`\
`# A: Drug X          0       0       0  `\
...
\
`tmp_adsl``$``new2`` ``<-`` `[`addNA`](https://rdrr.io/r/base/factor.html)`(``tmp_adsl``$``new1``)`\
[`levels`](https://rdrr.io/r/base/levels.html)`(``tmp_adsl``$``new2``)``[``4``]`` ``<-`` ``"<NA>"`` ``# NA needs to be a recognizible string`\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``tmp_adsl``, row_vars ``=`` ``"ARM"``, col_vars ``=`` ``"new2"``)`\
`#                    X       Y       Z      <NA>  `\
...
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, row_vars ``=`` ``"STRATA2"``, col_vars ``=`` ``"ARM"``, avar ``=`` ``"AGE"``, afun ``=`` ``mean``)`\
`#              A: Drug X   B: Placebo   C: Combination`\
...
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, row_vars ``=`` ``"STRATA2"``, col_vars ``=`` ``"ARM"``, avar ``=`` ``"AGE"``, afun ``=`` ``range``)`\
`#                A: Drug X    B: Placebo    C: Combination`\
...
\
`fivenum2`` ``<-`` ``function``(``x``)`` ``{`\
`  `[`setNames`](https://rdrr.io/r/stats/setNames.html)`(`[`as.list`](https://rdrr.io/r/base/list.html)`(`[`fivenum`](https://rdrr.io/r/stats/fivenum.html)`(``x``)``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``"min"``, ``"Q1"``, ``"MED"``, ``"Q3"``, ``"max"``)``)`\
`}`\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, row_vars ``=`` ``"STRATA2"``, col_vars ``=`` ``"ARM"``, avar ``=`` ``"AGE"``, afun ``=`` ``fivenum2``)`\
`#                  A: Drug X   B: Placebo   C: Combination`\
...
`    ``"Range"`` ``=`` `[`rcell`](https://pharmaverse.github.io/rtables/reference/rcell.md)`(`[`range`](https://rdrr.io/r/base/range.html)`(``x``)``, format ``=`` ``"xx - xx"``)`\
`  ``)`\
`}`\
\
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(``ex_adsl``, row_vars ``=`` ``"STRATA2"``, col_vars ``=`` ``"ARM"``, avar ``=`` ``"AGE"``, afun ``=`` ``meansd_range``)`\
`#                       A: Drug X      B: Placebo    C: Combination`\
...
[`qtable`](https://pharmaverse.github.io/rtables/reference/qtable_layout.md)`(`\
`  ``ex_adsl``,`\
`  row_vars ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"STRATA1"``, ``"STRATA2"``)``, col_vars ``=`` ``"ARM"``,`\
`  avar ``=`` ``"AGE"``, afun ``=`` ``mean`\
`)`\
`#              A: Drug X   B: Placebo   C: Combination`\
`# AGE - mean    (N=134)     (N=134)        (N=132)    `\
...
`  subtitle ``=`` `[`paste0`](https://rdrr.io/r/base/paste.html)`(``"STUDY "``, ``ex_adsl``$``STUDYID``[``1``]``)``,`\
`  main_footer ``=`` `[`paste0`](https://rdrr.io/r/base/paste.html)`(``"Date: "``, `[`as.character`](https://rdrr.io/r/base/character.html)`(`[`Sys.Date`](https://rdrr.io/r/base/Sys.time.html)`(``)``)``)`\
`)`\
`# Strata 2 Summary`\
`# STUDY AB12345`\
`# `\
